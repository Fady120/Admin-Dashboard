...
const Item = ({ title, to, icon, selected, setSelected}) => {
    ...
    return (
        <MenuItem onClick={() => setSelected(title)} active={selected === title} style={{ color: colors.grey[100]}} icon={icon}>
            ...
            <ProSidebar collapsed={isCollapsed}>
                <Menu iconShape="square">
                    ...
                    {!isCollapsed && (
                         <Box mb="25px">
                            <Box display="flex" justifyContent="center" alignItems="center">
                                <img alt="profile-user" width="100px" height="100px" src={'../../s.jpg'} style={{ cursor: "pointer", borderRadius: "50%"}} />
                            </Box>
                            <Box textAlign="center">
                                <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{margin: "10px 0 0 0"}}> Fady Samy </Typography>
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        <Typography variant="h6" color={colors.grey[300]} sx={{ margin: "15px 0 5px 20px" }}> Data </Typography>
                        ...
                        <Typography variant="h6" color={colors.grey[300]} sx={{ margin: "15px 0 5px 20px" }}> Pages </Typography>
                        ...
                        <Typography variant="h6" color={colors.grey[300]} sx={{ margin: "15px 0 5px 20px" }}> Charts </Typography>
